...
- Name: features.spec.ts >> Sangathan Platform Features Page >> 2. Verify switching between organization tabs reveals respective categories and features
- Location: tests\e2e\features.spec.ts:45:7
...
Locator: getByRole('button', { name: 'Student Unions' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Student Unions' })
