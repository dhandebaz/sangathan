const fs = require('fs');
let content = fs.readFileSync('src/app/[lang]/(site)/transparency/page.tsx', 'utf8');
...
const startIdx = content.indexOf('{/* Data Collection Transparency */}');
const endIdx = content.indexOf('{/* Governance & Neutrality */}');

if (startIdx !== -1 && endIdx !== -1) {
  content = content.substring(0, startIdx) + replacement + '\n\n        ' + content.substring(endIdx);
  fs.writeFileSync('src/app/[lang]/(site)/transparency/page.tsx', content);
  console.log('Success');
} else {
