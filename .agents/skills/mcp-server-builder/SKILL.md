...
description: Builds Model Context Protocol (MCP) servers for Codex with tools, resources, and prompts. Use when users request "create MCP server", "build Codex tool", "MCP integration", or "custom Codex tools".
---

# MCP Server Builder

Create Model Context Protocol servers to extend Codex's capabilities with custom tools and resources.
...
7. **Deploy**: Configure for Codex Desktop or API
...
```json
// ~/Library/Application Support/Codex/claude_desktop_config.json (macOS)
// %APPDATA%\Codex\claude_desktop_config.json (Windows)
{
  "mcpServers": {
    "my-mcp-server": {
      "command": "node",
...
6. **Document tools well**: Clear descriptions help Codex use them correctly
