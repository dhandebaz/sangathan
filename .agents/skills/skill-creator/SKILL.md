---
name: skill-creator
description: Creates new Codex skills following repository conventions with proper structure, frontmatter, workflows, code examples, and reference files. Use when users request "create a skill", "new skill", "generate skill", or "add skill to collection".
---

# Skill Creator

Generate production-ready Codex skills following established conventions.
