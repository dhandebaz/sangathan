...
@section('page-subtitle', 'Create a new meeting for your organisation')
...
<div class="max-w-4xl mx-auto">
    <div class="card">
        ...
        <form method="POST" action="{{ route('meetings.store') }}" class="card-body space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="general" {{ old('meeting_type') === 'general' ? 'selected' : '' }}>General Meeting</option>
                        <option value="core" {{ old('meeting_type') === 'core' ? 'selected' : '' }}>Core Committee Meeting</option>
                            ...
                            @foreach($members as $member)
                                <label class="flex items-center space-x-3 cursor-pointer hover:bg-orange-50 p-2 rounded">
                                    <input 
                                        ...
                                        name="attendees[]" 
                                        value="{{ $member->id }}"
                                        {{ in_array($member->id, old('attendees', [])) ? 'checked' : '' }}
