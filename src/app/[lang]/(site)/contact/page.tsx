    ...
    <div className="bg-white dark:bg-transparent min-h-screen">
      ...
      <div className="max-w-5xl mx-auto py-16 px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          <div className="p-8 bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/10 rounded-3xl hover:border-indigo-500/50 transition-colors group">
             ...
             <h3 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">{isHindi ? 'सामान्य सहायता' : 'General Support'}</h3>
             ...
             <a href="mailto:support@sangathan.space" className="text-indigo-600 dark:text-indigo-400 font-bold hover:underline">support@sangathan.space</a>
          </div>

          <div className="p-8 bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/10 rounded-3xl hover:border-red-500/50 transition-colors group">
             <div className="w-12 h-12 rounded-2xl bg-white dark:bg-white/10 border border-slate-200 dark:border-white/10 flex items-center justify-center mb-6">
               <ShieldAlert className="w-6 h-6 text-red-500 group-hover:scale-110 transition-transform" />
             </div>
             <h3 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">{isHindi ? 'विश्वास और सुरक्षा' : 'Trust & Safety'}</h3>
             <p className="text-slate-500 dark:text-slate-400 mb-6">
                {isHindi
             ...
             <a href="mailto:abuse@sangathan.space" className="text-red-500 dark:text-red-400 font-bold hover:underline">abuse@sangathan.space</a>
          </div>

          <div className="p-8 bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/10 rounded-3xl hover:border-emerald-500/50 transition-colors group">
             <div className="w-12 h-12 rounded-2xl bg-white dark:bg-white/10 border border-slate-200 dark:border-white/10 flex items-center justify-center mb-6">
               <CreditCard className="w-6 h-6 text-emerald-500 group-hover:scale-110 transition-transform" />
             </div>
             <h3 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">{isHindi ? 'बिलिंग और रिफंड' : 'Billing & Refunds'}</h3>
             <p className="text-slate-500 dark:text-slate-400 mb-6">
                {isHindi
             ...
             <a href="mailto:billing@sangathan.space" className="text-emerald-600 dark:text-emerald-400 font-bold hover:underline">billing@sangathan.space</a>
          </div>

          <div className="p-8 bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/10 rounded-3xl hover:border-cyan-500/50 transition-colors group">
             <div className="w-12 h-12 rounded-2xl bg-white dark:bg-white/10 border border-slate-200 dark:border-white/10 flex items-center justify-center mb-6">
               <MessageSquare className="w-6 h-6 text-cyan-500 group-hover:scale-110 transition-transform" />
             </div>
             <h3 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">{isHindi ? 'मीडिया और प्रेस' : 'Media & Press'}</h3>
             <p className="text-slate-500 dark:text-slate-400 mb-6">
                {isHindi
             ...
             <a href="mailto:press@sangathan.space" className="text-cyan-600 dark:text-cyan-400 font-bold hover:underline">press@sangathan.space</a>
          </div>
        </div>

        <div className="bg-slate-50 dark:bg-white/[0.02] p-8 rounded-3xl border border-slate-200 dark:border-white/10 text-center max-w-2xl mx-auto">
           <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">{isHindi ? 'प्रतिक्रिया समय की उम्मीदें' : 'Response Time Expectations'}</h3>
