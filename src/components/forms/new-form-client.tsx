...
export function NewFormClient({ lang }: NewFormClientProps) {
        ...
        <div className="content-card rounded-lg space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full border rounded-md p-2 focus:ring-2 focus:ring-orange-500 outline-none bg-white"
            >
              <option value="public">Public - Anyone can submit</option>
              <option value="members">Members Only - Requires organization member login</option>
              <option value="private">Private - Only admins/editors/executives can submit</option>
            </select>
          </div>
        </div>
